  ...
  <div class="login-wrap">
    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px"
      ...
      <el-form-item style="width:100%;">
        <el-button type="primary" style="width:100%;" @click="submitForm('ruleForm')" :loading="login">登录</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      /*  if (valid) {*/
      /*    this.logining = true*/
      /*    if (this.ruleForm.username === 'root' && this.ruleForm.password === 'root') {*/
      /*      this.logining = false*/
      /*      */
      /*      localStorage.setItem('token', 'token')*/
      /*      localStorage.setItem('studentId', this.ruleForm.username)*/
      //       if (this.ruleForm.username === 1053 || this.ruleForm.username === '1053') {
